                    ...
                    if (result._STATUS_ == 'FAIL') {
                        ...
                        if (data.length == undefined || data.length == 0) {
                            ...
                            for (i = 0; i < data.length; i++) {
                                ...
                                //$("#cboBasicQualification").val(data[i].chrBasicQualification.trim()).change();
                                ...
                                $("#txtOtherQualification").val(data[i].varOtherQualification);
    ...
    var validator = $("#frmMain").validate(
        {
            ...
            messages: {
                ...
                txtPassport: {
                    check_exp: "Only alphabets and numbers without leading / trailing space are allowedallowed",
                },
                txtVoterId: {
                    check_exp: "Only alphabets and numbers without leading / trailing space are allowed",
                },
