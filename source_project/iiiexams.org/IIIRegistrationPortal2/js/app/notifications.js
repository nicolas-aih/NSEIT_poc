            ...
            success: function (msg) {
                ...
                if (result._STATUS_ == 'FAIL') {
                    ...
                    if (data.length == undefined || data.length == 0) {
                        ...
                        //s += "<thead><tr><td>&nbsp</td><td>Caption</td><td>Content</td><td>Display From</td><td>Display Till</td><td>Display Options</td><td>Attachments</td></tr></thead>";
                        //data[i].notification_id
                        //data[i].notification_text
                        //data[i].start_date
                        //data[i].end_date
                        //data[i].display_mode
                        //data[i].attachment
                        ...
                        //data[i].display_br
                        //data[i].display_i
                        //data[i].notification_caption
                        //data[i].display_others
                        //for (i = 0; i < data.length; i++) {
                        //    s += "<tr>";
                        //    s += "<td><a href='javascript:edit(" + data[i].notification_id + ")'>Edit</a></td><td width='300px'>" + data[i].notification_caption + "</td><td width='300px'>" + data[i].notification_text + "</td><td>" + data[i].start_date + "</td><td>" + data[i].end_date + "</td><td width='300px'>Display to CA ? :" + data[i].display_ca + "<br>Display to WA ? :" + data[i].display_wa + "<br>Display to IMF ? :" + data[i].display_imf + "<br>Display to BR ? :" + data[i].display_br + "<br>Display to Insurers ? :" + data[i].display_i + "<br>Display to Others ? :" + data[i].display_others + "</td><td width='300px'>" + data[i].attachment + "</td>";
                        //    s += "</tr>";
                        //}
                        //s += "</table>";
                        ...
                        for (i = 0; i < data.length; i++) {
                            s += "<li>";
                            s += "<div style='border:1px solid gray'>"
                            s += "<div style='background-color:lightgray;margin:5px;padding:5px'>";
                            s += "<div class='row mt10'>";
                            s += "<div class='col-sm-4'>Start Date : " + data[i].start_date + "</div>"
                            s += "<div class='col-sm-4'> End Date : " + data[i].end_date + "</div >"
                            s += "<div class='col-sm-4'><a href='javascript:edit(" + data[i].notification_id + ")'>Edit this notification</a></div>";
                            s += "</div>";
                            s += "<div class='row mt10'>";
                            s += "<div class='col-sm-4'>Display to CA ? :" + data[i].display_ca + "</div>";
                            s += "<div class='col-sm-4'> Display to WA ? :" + data[i].display_wa + "</div>";
                            s += "<div class='col-sm-4'>Display to IMF ? :" + data[i].display_imf + "</div>";
                            s += "</div>";
                            s += "<div class='row mt10'>"
                            s += "<div class='col-sm-4'>Display to BR ? :" + data[i].display_br + "</div>";
                            s += "<div class='col-sm-4'>Display to Insurers ? :" + data[i].display_i + "</div>";
                            s += "<div class='col-sm-4'> Display to Others ? :" + data[i].display_others + "</div>";
                            s += "</div>";
                            s += "</div>";
                            s += "<div style='font-weight:600; margin:5px;padding:5px'>" + data[i].notification_caption + "</div>";
                            s += "<div style='margin:5px;padding:5px'>" + data[i].notification_text + "</div>";
                            if (!(data[i].attachment == null || data[i].attachment == "" || data[i].attachment == undefined)) {
                                s += "<div style='font-style:italic; font-size:smaller; text-align:right; margin:5px;padding:5px'><a href='../NotificationDocs/" + data[i].attachment + "' target='_blank'>download</a></div>";
                            }
                            s += "</div>"
                            s += "</li >";
                        }
