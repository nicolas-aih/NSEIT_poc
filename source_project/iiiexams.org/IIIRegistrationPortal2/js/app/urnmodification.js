$(document).ready(function () {
    ...
    $("#frmSearch").validate({
        ...
        submitHandler: function (form) {
            ...
            $.ajax({
                type: "POST",
                url: "../Candidates/URNModification",
    ...
    jQuery.validator.addMethod(
        ...
        function (value, element) {
            ...
            $.ajax({
                type: "POST",
                async: false,
                url: "../Services/ValidateWhatsAppCorporates",
                data: JSON.stringify(JsonObject),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (msg) {
    ...
    var validator = $("#frmMain").validate(
        {
            ...
            invalidHandler: function (event, validator) {
                alert("Unable to save. Some of the fields have errors (The same are highlighted).")
            },
            submitHandler: function (form) {
                var data = new FormData(form);
                if (!data.has("cboProfessionalQualification")) {
                    data.append("cboProfessionalQualification", $("#cboProfessionalQualification option:selected").val());
                }
                $.ajax({
                    type: "POST",
                    enctype: 'multipart/form-data',
                    url: "../Candidates/SaveURNModification",
                    data: data,
                    processData: false,
                    contentType: false,
                    cache: false,
    ...
    window.DownloadP = function () {
        var data = new FormData();
        data.append("txtURN", $("#hdnURN").val());
        data.append("Type", "B");
        $.ajax({
            type: "POST",
            enctype: 'multipart/form-data',
